 ...
 * 
 * [タイトルシーン識別子]と[メニューシーン識別子]
 * 　ここに書いた識別子のカスタムメニューに入れ替えます。
 * 
 * [メニューコモンイベント]
 * 　名前か番号で指定したコモンイベントを
 * 　メニュー表示前に実行します。
 * 
 * 
 * また、シーン全体ではなくコマンド単位の入れ替えもできます。
 * 
 * [タイトル標準コマンド削除]と[メニュー標準コマンド削除]
 * 　標準のコマンドを全部削除します。
 * 
 * [タイトル追加コマンド]と[メニュー追加コマンド]
 * 　[コマンドラベル]の文字が選択肢に表示されます。
 * 　[スクリプト]があれば実行されます、その後…
 * 　[シーン識別子]設定されていればカスタムシーンに変わります。
 * 　空なら[シーンクラス名]のシーンに変わります。
 * 　[シーン識別子]にプリセットの値を選べば、
 * 　標準の機能と同じ動作が可能です。
 * 
 * ＿＿＿＿ 部品位置 ＿＿＿＿ 以下のパラメータは
 * 多くのシーンに共通する部品の位置を指定します。
 */
