...
変化のあるシステムデータを扱うクラス。<br />
プラグインのデータを保存するオブジェクトとして利用されることが多いが、特に識別子の衝突について対策がされているわけではないので、別の作者が作ったプラグイン同士で識別子が被ってしまうことがある。

v1.3.0、v1.7.0、v1.8.1 で変更あり。
