...
| 識別子 | 型 | 説明 |
| --- | --- | --- |
| `_shopGoods` | [Array](Array.md).&lt;[Array](Array.md).&lt;*&gt;&gt; | [商品の配列](#商品の配列)の配列 |
...
| 番号 | 型 | 説明 |
| --- | --- | --- |
| 0 | [Number](Number.md) | 種類(0:アイテム, 1:武器, 2:防具) |
| 1 | [Number](Number.md) | アイテムID |
| 2 | [Number](Number.md) | 値段 |
...
**@MZ** 商品の配列をアイテムオブジェクトにして返す。

##### 引数

| 名前 | 型 | 説明 |
| --- | --- | --- |
| `goods` | [Array](Array.md) | [商品の配列](#商品の配列) |
...
| 名前 | 型 | 説明 |
| --- | --- | --- |
| `shopGoods` | [Array](Array.md).&lt;[Array](Array.md).&lt;*&gt;&gt; | [商品の配列](#商品の配列)の配列 |
