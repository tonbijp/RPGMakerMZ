...
#### initialize (rect)
オーバーライド: [Window_HorzCommand](Window_HorzCommand.md#initialize-rect)
...
**@MZ** 指定[アイテムカテゴリー]を表示するか。

##### 引数

| 名前 | 型 | 説明 |
| --- | --- | --- |
| `name` | [String](String.md) | [アイテムカテゴリー](#アイテムカテゴリー) |


#### needsSelection () → {Boolean}
**@MZ** 複数のアイテムカテゴリーがあり、選択の必要があるか。
