...
| 識別子 | 型 | 説明 |
| --- | --- | --- |
| `lastTopRow` | [Number](Number.md) | [static] 最後に選択していた画面の上の行 |
| `lastIndex` | [Number](Number.md) | [static] 最後に選択していた値の番号 |
...
指定番号で[表示モード](Window_DebugEdit.md#表示モード)を判断して返す。
...
| 名前 | 型 | 説明 |
| --- | --- | --- |
| `editWindow` | [Window_DebugEdit](Window_DebugEdit.md) | 編集ウィンドウ |
