...
**@MZ** オーバーライド: [Window_Selectable](Window_Selectable.md#rowspacing---number)
...
#### update ()
**@MZ** オーバーライド: [Window_Selectable](Window_Selectable.md#update-)


#### updatePadding ()
**@MZ** オーバーライド: [Window_Base](Window_Base.md#updatepadding-)
