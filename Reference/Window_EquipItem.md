...
| `_slotId` | [Number](Number.md) | [装備タイプ]ID |
...
**@MZ** オーバーライド: [Window_ItemList](Window_ItemList.md#colspacing---number)
...
**@MZ** オーバーライド: [Window_ItemList](Window_ItemList.md#maxcols---number)


#### playOkSound ()
オーバーライド: [Window_Base](Window_Base.md#playoksound-)
...
| 名前 | 型 | 説明 |
| --- | --- | --- |
| `slotId` | [Number](Number.md) | [装備タイプ]ID |
